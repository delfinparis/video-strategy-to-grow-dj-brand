...
<style>
  ...
  * { box-sizing: border-box; margin:0; padding:0; }
  ...
  .col ol { margin-left:16px; list-style:decimal; }
...
<body><div class="page">
  <div class="hdr">
    ...
    <div class="kicker">Kale Mentors</div>
    <h1>Share Your Why &mdash; Mentor Cheat Sheet</h1>
    <div class="sub">You record a quick, raw clip about being a mentor. D.J. edits it into a polished video you can post to attract clients and good people. That's the whole deal &mdash; about 5 minutes.</div>
  </div>
  <div class="body">
    ...
    <div class="sec">
      ...
      <div class="note">Just talk like you're telling a friend. No script needed. Speak from the heart.</div>
      <ul>
        <li>Why did you become a mentor?</li>
        <li>What's a win you've had with one of your mentees?</li>
        <li>What's your favorite part of being a mentor?</li>
        <li>What would you tell an agent thinking about becoming a mentor?</li>
      </ul>
...
out = os.path.join(HERE, "Mentor-Share-Your-Why-Cheat-Sheet.html")
