...
_Generated by `scripts/stupid_things.py render` on 2026-09-15. Do not hand-edit this region; edit `data/stupid-things.json`._

**54 available** of 69 practices (target 20, refill at 5).

### After the close

| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0014 | Disappearing the day after closing and never contacting the client again | self | NAR 2025 Profile of Home Buyers and Sellers 2025 | 3 | 1 |

### Agent-to-agent cooperation

| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0020 | Never replying to showing feedback requests, leaving the seller in the dark | sideways | **needed** | 1 | 1 |
...
| ST-0023 | Sitting on a submitted offer with no acknowledgment of receipt | sideways | **needed** | **spent** | 1 |
| ST-0024 | Setting an offer deadline and never telling the other agents the seller already accepted | sideways | NAR 2026 Code of Ethics, Standard of Practice 1-15 2026 | **spent** | 1 |
...
| ST-0055 | Badmouthing the other agent or the seller in front of your own buyers | sideways | NAR 2026 Code of Ethics, Article 15 and SOP 15-2/15-3 2026 | **spent** | 2 |
...
| ST-0052 | Taking undisclosed kickbacks from recommended inspectors, lenders, or title companies | sideways | RESPA Section 8, 12 U.S.C. 2607 (prohibition also at 12 CFR 1024.14) 2026 | 1 | 2 |
...
| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0049 | Talking buyers into waiving the inspection to make the offer look cleaner | self | NAR REALTORS Confidence Index, September 2024 2024 | **spent** | 2 |
...
| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0063 | Taking four hours to respond to a new lead, then blaming the lead quality | self | **needed** | 1 | 1 |
| ST-0064 | One-and-done follow-up, marking a lead dead after a single unanswered text | self | **needed** | 1 | 1 |
| ST-0065 | Buying more leads to fix what is actually a follow-up problem | self | **needed** | 1 | 0 |
...
| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0056 | Not knowing basic factual things about the neighborhood you sell in | self | NAR 2026 Member Profile via HousingWire 2026 | 1 | 1 |
...
| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0036 | Throw it on the MLS and pray, with no staging, no marketing plan, and no launch | self | **needed** | 1 | 0 |
...
| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0005 | Photographing a client's largest asset on a phone, in bad light, and putting it in the MLS | self | **needed** | 2 | 5 |
| ST-0006 | Writing 'Beautiful home, must see!' as the entire MLS description | self | **needed** | 2 | 3 |
...
| ST-0013 | Running down the agent on the other side of the deal in front of your own client | sideways | NAR 2026 Code of Ethics, Article 15 and SOP 15-2/15-3 2026 | **spent** | 2 |

### Personal brand and digital presence

| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0042 | Posting nothing but Just Listed, Just Sold, and call me graphics | self | **needed** | 1 | 1 |
...
| ST-0045 | Having a dead or broken digital presence when the client Googles you | self | **needed** | 1 | 0 |

### Pricing and listing intake

| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0001 | Taking a listing at a price the comps don't support, because another agent already agreed to it and you don't want to lose the appointment | self | Realtor.com 2026 | 1 | 2 |
...
| ST-0041 | Being unable to explain the difference between the tools you have and the work you do | self | **needed** | 1 | 0 |

### Responsiveness and communication

| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0002 | Going radio silent after the contract is signed, as if the job ended at acceptance | sideways | **needed** | 1 | 4 |
| ST-0003 | Not returning the buyer's agent's call on a live submitted offer | sideways | **needed** | 2 | 3 |

### Showings and access

| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0011 | Listing a property with no showing instructions, no working lockbox, and a phone number nobody answers | sideways | **needed** | **spent** | 3 |
| ST-0025 | Call agent to show with no lockbox, turning a showing into a multi-day ordeal | sideways | **needed** | **spent** | 1 |
| ST-0026 | Not confirming showings, so buyers get dragged across town to a locked door | sideways | **needed** | 1 | 0 |
| ST-0027 | Showing up late or no-showing and blowing up everyone else's schedule | sideways | **needed** | 1 | 1 |
| ST-0028 | Overstaying the showing window while the next agent and their buyers wait | sideways | **needed** | 1 | 1 |
| ST-0029 | Taking days to schedule a showing while the listing sells to somebody faster | self | **needed** | 1 | 1 |
| ST-0030 | The part-timer who hides the day job and cannot keep pace with the transaction | self | NAR 2026 Member Profile via HousingWire 2026 | **spent** | 2 |
...
| ST-0067 | The secret agent who is too embarrassed to tell their own network what they do for a living | self | **needed** | 1 | 1 |

### The listing itself

| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0031 | Dark, blurry, badly composed iPhone photos on the MLS | self | **needed** | **spent** | 3 |
| ST-0032 | Calling a windowless or closetless room a bedroom in the listing | sideways | 2024 International Residential Code, Section R310 (emergency escape and rescue openings) and R304/R303 2024 | **spent** | 2 |
| ST-0033 | Submitting an incomplete MLS listing with no room sizes, no remarks, and no HOA information | self | **needed** | **spent** | 1 |
| ST-0034 | Over-Photoshopping listing images so the house is unrecognizable in person | self | **needed** | 1 | 1 |
...
| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0016 | The pre-contract superstar who disappears after the client signs | self | **needed** | **spent** | 1 |
