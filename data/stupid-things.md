...
| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0002 | Going radio silent after the contract is signed, as if the job ended at acceptance | sideways | NAR 2026 | 1 | 4 |
...
| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0011 | Listing a property with no showing instructions, no working lockbox, and a phone number nobody answers | sideways | Virtuance 2026 | 1 | 3 |
