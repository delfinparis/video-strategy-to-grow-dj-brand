...
_Generated by `scripts/stupid_things.py render` on 2026-09-10. Do not hand-edit this region; edit `data/stupid-things.json`._

**59 available** of 69 practices (target 20, refill at 5).
...
| ID | Practice | Target | Receipt | Open angles | Sightings |
|---|---|---|---|---|---|
| ST-0049 | Talking buyers into waiving the inspection to make the offer look cleaner | self | NAR REALTORS Confidence Index, September 2024 2024 | 1 | 2 |
