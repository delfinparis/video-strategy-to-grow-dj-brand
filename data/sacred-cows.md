...
Standing candidates for the 3 weekly **take carousels** (heat 3.5). A take is a
defensible contrarian position that names a wrong default, cites a source, and hands the
agent something to do. Not a rant, not news.
...
**3.5, and no higher.** Rule 9.2 caps heat 4-5 at one post a week and that slot belongs
to video. Heat 3.5 is "defensible contrarian, cites a source, names the wrong default,"
which the register already describes as high comment volume at manageable risk.

**Never name a person, a brokerage, or a coaching program.** That is heat 5 and it is not
what these are for. Point at the practice and the incentive behind it.
