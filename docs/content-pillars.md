...
**Format:** talking-head walk-and-talk, 30-35s written to 30 (hard cap 35s), teaching one thing on camera and gating a deeper artifact.
...
**Format:** the Inside the Industry NF (news flash) and IS (synthesis) sub-types, 30-35s written to 30 (hard cap 35s), sharp take on real estate industry news within 24 hours, Chicago angle where possible. 2 of the best stories per week, not every story.
...
**Format:** talking-head walk-and-talk, 30-35s written to 30 (hard cap 35s), Mon/Wed/Fri. Full standard: [`series/take-standard.md`](series/take-standard.md).
