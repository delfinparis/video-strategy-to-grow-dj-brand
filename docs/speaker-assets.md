...
| Variant | Audience | Length | Emphasis |
|---|---|---|---|
| Keynote (full) | NAR NXT, Inman Connect, state associations | 45-60 min | All three parts, deep examples |
| Keynote (short) | Brokerage retreats, conference panels | 20-30 min | Part 2 (top producer patterns) dominant |
| Workshop | Masterminds, BAM-style events | 60-90 min | Interactive, audience brings current questions |
| Panel contribution | Any industry panel | 10-15 min | Part 1 (NAR inside view) dominant |

---

## 2. 90-Second Sizzle Reel

The single most important asset. This is the video conference programmers, brokerage owners, and NAR staff will watch before deciding whether to return a booking inquiry email.
...
"Here's an example. Last month the Tuccori settlement closed the book
on the buyer side of the commission lawsuits. Every headline said more
uncertainty, more change, more to worry about. But when I look at my
notes from the last 100 episodes, the top producers I interview every
week aren't panicking. They adapted two years ago. They're pricing
their value more clearly than ever. And they're winning more business
than they did before any of the lawsuits started. The gap between
what the headlines say and what the top agents are actually doing is
the biggest opportunity in this industry right now. And almost
nobody is talking about it."

[0:58-0:82] FRAMEWORK REVEAL

"I call it Inside the Industry. Three things the outside doesn't see:
what NAR leadership is actually prioritizing, what top producers are
actually doing, and where the real opportunity is hiding. Seven
hundred interviews taught me this framework. I'm ready to bring it
to your stage."
...
|---|---|
| Location | Podcast studio or Kale Realty conference room. Real working environment, not a staged "studio look." |
| Framing | Mid-chest up, eyes directly into lens. No angle tricks. |
| Lighting | Key light from 10 o'clock position. Softbox kit or consistent window light during golden hour. |
...
### Production Anti-Patterns (Do NOT)
...
[90-SECOND SIZZLE REEL EMBEDDED HERE]
...
actually doing differently, and where the real risk and opportunity
are hiding in the gap between the two. Attendees walk away with a
clear map of what to ignore, what to focus on, and one specific
adjustment to make Monday morning.

**Best for:** Real estate industry conferences, state and local
REALTOR association events, NAR programming, brokerage retreats,
agent masterminds.

**Length options:** 20 min panel contribution / 30 min short keynote
/ 45-60 min full keynote / 90 min interactive workshop.

---

## Recent Stages

<!-- Start this section empty. Add each venue as you book. Even unpaid
local board talks count. Target 3-5 entries by end of 2026. -->
...
## 5. Speaker One-Sheet (PDF, 2 pages)

Conference organizers and brokerage owners will ask for a "one-sheet" or "speaker sheet." Build it once in Canva, reuse forever.
...
- "About D.J." paragraph (from speaker page copy above)
- "Recent Stages" list (start empty, grow it)
- QR code or short link to sizzle reel
- Social handles (LinkedIn, Instagram)
- Podcast listening links (Apple, Spotify, main website)

Format: 2-page PDF, letter size. Canva has templates. Keep it to 2 pages max.

---

## 6. First 7 Days of Action

| Day | Action |
|---|---|
| 1 | Review this document. Approve or tweak the signature talk title and sizzle script. |
| 2 | Record the 90-second sizzle reel. 3-5 takes, pick the best one. |
...
## 8. The Asset That Unlocks Everything Else
