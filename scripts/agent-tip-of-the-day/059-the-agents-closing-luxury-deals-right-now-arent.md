...
day: "Thursday"
source_file: "2026-01-26_item5_Carrie-McCormick_clip0_v2.json"
...
> **Strongest Line:** "The fast agent closes that deal and deals with the fallout. The strategic agent reads the minutes, does the math, and says 'we walk.'"
...
### CTA (0:50-0:60)
Tonight, pull your last three closed deals. Open the inspection reports. Find one thing you didn't explain to your client that you should have. Tomorrow morning, record a 60-second video explaining that one thing. Post it. That's how you become the strategy agent. Full breakdown in bio.

*Production: Carrie looking directly at camera. Text overlay step-by-step: '1. Pull last 3 deals' | '2. Find the missed insight' | '3. Record 60 sec video' | '4. Post tomorrow AM.' End card with episode thumbnail and link graphic.*

## Social Media
**Caption:** Speed used to win. Not anymore. Here's the one thing top producers do that most agents skip entirely.
**Hashtags:** #realestatestrategy #topproducer #realestateagent #luxuryrealestate #agentmindset
