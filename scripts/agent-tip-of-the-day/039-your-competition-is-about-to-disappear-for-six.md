...
day: "Saturday"
source_file: "2025-10-29_item22_Carrie-McCormick_clip0_v2.json"
...
### REFRAME (0:38-0:50)
What you do in Q4 sets up your entire next year. While they're gliding, you're loading the pipeline. January 1st, you wake up with ten warm conversations already going. They wake up cold.

*Production: Visual contrast: split screen showing 'Your January' (full pipeline graphic) vs 'Their January' (empty pipeline/starting from zero)*
...
*Production: Screen recording showing CRM filter being applied, ending with results populating. Final frame: 'Your move.' text overlay*

## Social Media
**Caption:** Q4 is when top producers separate from the pack. Here's the database play most agents miss.
**Hashtags:** #RealEstateAgent #Q4Strategy #DatabaseMarketing #TopProducerSecrets #RealEstateSales
