...
reskinned_from: "KIRP-2026-09-21-frozen-exclusion-carousel"
heat: "4"
---
...
### LinkedIn
The capital gains exclusion on a home sale is $250,000 single, $500,000 married. That number was set in 1997 and has never moved since.

Most agents find out a long-held listing has outrun it at the closing table, not before. That is a tax conversation an agent should be equipped to start at the listing appointment, and most never get shown how.

Kale Realty agents get trained on the numbers that actually change a listing conversation, not just handed a split. Learn more at joinkale.com.

#RealEstateCareers #CapitalGains #RealEstateBrokerage

### Instagram
This number hasn't moved since 1997. $250,000 single, $500,000 married, and it still catches long-held listings by surprise at closing.

If nobody ever trained you to run that math before the listing appointment, that's not on you. It's on the brokerage.

Kale Realty agents get that training. Learn more at joinkale.com.

#RealEstateAgents #RealEstateCareers #CapitalGains

### Facebook
The home sale capital gains exclusion hasn't changed since 1997, and it still surprises sellers at closing. Kale Realty agents get trained to catch it before the listing appointment, not after. Learn more at joinkale.com.
