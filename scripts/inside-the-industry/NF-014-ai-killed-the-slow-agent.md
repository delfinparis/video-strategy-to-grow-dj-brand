...
type: "reactive"
script_number: "NF-014"
title: "AI Didn't Kill the Real Estate Agent. It Killed the Slow Agent."
avatar: "All"
...
# AI Didn't Kill the Real Estate Agent. It Killed the Slow Agent.

> **WOW: Contrarian take plus mindset reframe plus memorable one-liner. The dominant tech-doomer narrative has predicted AI's disintermediation of real estate agents for years. NAR's 2025 Profile of Home Buyers and Sellers shows 88% of buyers still use an agent. RISMedia's April 2026 reporting confirmed consumers expect AI in the homebuying process and still want a person. The agents losing business aren't losing it to AI. They're losing it to faster agents who use AI. The real disruption is response-time compression and workflow speed. The contrarian framing flips the industry's AI anxiety: the threat isn't AI replacing you, it's the agent across town using it faster than you.**
...
- **Claim:** "88% of buyers still use an agent"
  - Source: National Association of REALTORS®, "2025 Profile of Home Buyers and Sellers" ([link](https://www.nar.realtor/blogs/economists-outlook/top-10-takeaways-from-nars-2025-profile-of-home-buyers-and-sellers))
  - Cross-confirmed: BAM, "88% of Home Buyers Still Rely on Agents, NAR 2025 Report Finds" ([link](https://nowbam.com/88-of-home-buyers-still-rely-on-agents-nar-2025-report-finds/))
...
- **Claim (qualitative framing):** "Pick one daily task. Use AI to cut its time in half"
  - Action guidance, not a claim about a specific time savings. The "half" is a target, not a measured outcome. No specific tool, no specific task, no fabricated efficiency number.
  - Status: action prompt, not a stat

- **Cross-reference within series:**
  - NF-011 (`NF-011-listing-presentations-dont-matter.md`) -- 81% of sellers only interview one agent. Pairs with the 88% buyer-side stat as evidence that the "agent disintermediation" narrative does not match consumer behavior on either side of the transaction.
  - NF-013 (`NF-013-jobs-report-listings-map.md`) -- sector-data-as-listings-map thesis. NF-014 is the workflow-side companion: NF-013 tells the agent where to look, NF-014 tells them how to be fast enough to win once they look.
...
That number comes from NAR's 2025 Profile of Home Buyers and Sellers. RISMedia reported last month that buyers expect AI in the process and still want a person. The disintermediation story we've all been bracing for didn't happen. Something else did.
...
That comes from NAR's 2025 Profile of Home Buyers and Sellers. RISMedia reported in April 2026 that buyers expect AI in the process and still want a person. The disintermediation story did not happen.
