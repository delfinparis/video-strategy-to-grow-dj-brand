...
Two. Lead with affordability, not rates. Marry the house, date the rate.
...
- **Timing of the "confirmed" framing:** Warsh was confirmed today, May 13, 2026, but had not yet been sworn in as chair as of filming. Powell's term ends Friday, May 15. Warsh is expected to be sworn in promptly after. Filming options:
  - **If filming Tuesday May 13 or Wednesday May 14:** spoken HOOK reads "Kevin Warsh just got confirmed as the next Fed chair." This is the version drafted.
  - **If filming Friday May 16 or later:** swap to "Kevin Warsh is the new Fed chair" or "Kevin Warsh just got sworn in as Fed chair."
  - The contextual content (rate views, inflation, FOMC math) does not change between framings. Only the lead clause.
- **First FOMC meeting under Warsh:** June 16-17, 2026. If a follow-up segment is desired, this is the natural date anchor for NF-017.
...
- **Claim:** "The Fed cut rates in 2024. Mortgage rates went up"
  - Source: U.S. News, May 2026, citing the September 2024 Fed 50 basis point cut and the contemporaneous bond-market reaction that pushed long-term mortgage rates higher
  - Status: confirmed (historical record)

- **Claim:** "Warsh wants to cut"
  - Source: Yahoo Finance, January 2026 reporting Warsh's stated view that the Fed can lower rates enough to make 30-year mortgages affordable again
  - Status: confirmed (Warsh's on-record position)

- **Claim:** "April CPI just hit 3.8 percent"
  - Source: U.S. News, May 13, 2026 (April 2026 CPI release)
  - Status: confirmed; this is the hottest reading in nearly three years per the source

- **Claim:** "Markets are pricing zero cuts this year"
  - Source: CNN, May 13, 2026 (fed-funds futures pricing as of confirmation)
  - Status: confirmed as of post date; market pricing moves with new data and the framing should be re-verified if filming is delayed more than seven days.

- **Claim (qualitative framing):** "Inflation is the gatekeeper"
  - Editorial reframe of the underlying data. Defensible against the CPI print and the FOMC dual-mandate structure (price stability + maximum employment). When CPI is running at 3.8 percent against a 2 percent target, the FOMC's room to cut is structurally limited regardless of who chairs the committee.
  - Status: editorial framing supported by source data

- **Claim (qualitative framing):** "The committee won't let him"
  - Editorial reframe. Defensible against the FOMC's twelve-vote structure (chair + seven governors + four rotating regional presidents). A chair does not unilaterally set rates. The current committee composition, combined with the inflation print, makes a fast cutting cycle structurally unlikely. Markets agree (zero cuts priced).
  - Status: editorial framing supported by FOMC structure and market pricing

- **Claim (qualitative framing):** "Your buying power isn't changing in the next sixty days"
  - Coaching benchmark, not a measured stat. The "sixty days" frames the immediate horizon (next FOMC meeting June 16-17, the typical mortgage pipeline window). The framing is defensible against the CNN reporting that markets see zero cuts and the historical pattern that mortgage rates move with the 10-year Treasury, which itself is unlikely to swing materially in sixty days absent a significant shock.
  - Status: editorial coaching framing, not a stat

- **Claim (qualitative framing):** "Marry the house, date the rate"
  - Real estate industry coaching aphorism, widely used since 2022-2023 mortgage rate spike. Not D.J.'s original phrasing. Used here as a tactical script the viewer can deploy with clients this week.
  - Status: editorial color, not a stat

- **Counter-trend (acknowledged for editorial integrity, not in spoken script):** Warsh has been openly critical of the Fed's mortgage-backed securities holdings on its balance sheet. The Dispatch, May 2026, reported his preference for balance-sheet reduction. If Warsh moves to sell down MBS holdings, the mechanical effect is upward pressure on mortgage rates -- the opposite of what consumers expect from a "dovish" chair. The spoken script does not include this nuance for length reasons. A follow-up NF could cover it if the balance-sheet question becomes public during Warsh's tenure.

- **Cross-reference within series:**
  - NF-012 (`NF-012-rates-arent-the-lever-life-events-are.md`) -- the rates-aren't-the-lever thesis. NF-016 extends this directly: even with a new Fed chair, rates aren't the lever, and even if the Fed cuts, mortgage rates may not follow.
  - NF-013 (`NF-013-jobs-report-listings-map.md`) -- sector-data-as-listings-map. NF-016 is the mortgage-side companion: agents should also be reading the bond market, not the Fed press conference, if they want to forecast mortgage moves.

- **Action layer:**
  - Action 1 (retire the "wait until rates drop" follow-up) routes through the agent's own CRM and follow-up cadence. No paid product needed.
...
The Fed does not set mortgage rates. The Fed sets the federal funds rate, which is what banks charge each other overnight. Mortgage rates track the 10-year Treasury yield, and the 10-year is driven by inflation expectations and the bond market. When the Fed did a surprise cut in 2024, long-term mortgage rates went up because the bond market read it as inflationary. So even if Warsh gets the cut he wants, mortgages might not follow. They might move the wrong way.

And right now, Warsh probably isn't getting the cut. April CPI just hit 3.8 percent. That is the hottest inflation print in nearly three years. The FOMC has 12 votes, not one. With inflation this hot, the committee is not in a rush to cut. Markets are pricing zero cuts for the rest of 2026.

Three things you do with this.

One. Retire the "wait until rates drop" client follow-up. The agents who used that script three years ago are still waiting. It is the laziest play in the business and it is not coming back.

Two. Lead with affordability, not rates. Marry the house, date the rate.

Three. When your buyer asks about the new Fed chair, say this. "The Fed doesn't set mortgage rates. Inflation is the gatekeeper. Your buying power isn't changing in the next sixty days. Let's talk about what we are actually doing."
...
Warsh wants to cut. The committee won't let him. April CPI just hit 3.8 percent. Inflation is the gatekeeper.

Three things to do this week.

One. Retire "wait until rates drop" as your follow-up. The agents who used it three years ago are still waiting.

Two. Lead with affordability. Marry the house, date the rate.
...
**Hashtags:**
#realestate #realtor #realtorlife #mortgagerates #chicagorealestate #housingmarket #realestate2026 #realestateagent #keepingitrealpodcast #chicagorealtor #insidetheindustry #fedchair
...
Warsh wants to cut. April CPI just hit 3.8 percent, the hottest reading in nearly three years. The FOMC has 12 votes, not one. Markets are pricing zero cuts for the rest of 2026.

Three things to do this week.

One. Retire "wait until rates drop" as your client follow-up. The agents who used that script three years ago are still waiting.

Two. Lead with affordability, not rates. Marry the house, date the rate.

Three. When your buyer asks about the new Fed chair, say this. "The Fed doesn't set mortgage rates. Inflation is the gatekeeper. Your buying power isn't changing in the next sixty days."
...
April CPI just hit 3.8 percent. Inflation is the gatekeeper.
