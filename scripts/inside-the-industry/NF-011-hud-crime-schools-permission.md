...
title: "HUD Just Told You to Stop Ducking the Crime and Schools Question"
avatar: "All"
...
> **WOW: Permission slip + tactical specificity -- HUD's "Dear Colleague" letter (HUD No. 26-028, April 24, 2026) clarifies that sharing objective crime data and school quality data with buyers is NOT a Fair Housing Act violation. The catch most agents will miss: data is fine, your opinion of the data is not. Concrete action: build a one-page buyer resource with crime stats and school ratings, hand it to every buyer, never voice an opinion about either.**
...
- **Claim:** "April 24th. HUD dropped a Dear Colleague letter."
  - Source: HUD "Dear Colleague" letter, identifier HUD No. 26-028, dated 2026-04-24, as referenced in NAR Washington Report 2026-04-29 ([link](https://www.nar.realtor/washington-report/hud-issues-dear-colleague-letter-on-school-and-crime-data))
  - Status: confirmed via NAR

- **Claim:** "Sharing crime data and school quality data with buyers is not a Fair Housing Act violation"
  - Source: NAR Washington Report 2026-04-29 paraphrasing the HUD letter: "[the letter] emphasiz[es] that it is not a violation of the Fair Housing Act to share information with prospective homebuyers about neighborhood crime rates and school quality data."
  - Status: confirmed

- **Claim:** "NAR confirmed it this week."
  - Source: NAR Washington Report dated 2026-04-29 explicitly aligning with HUD's position. Per NAR: "NAR's guidance has been consistent for decades," referencing four prior NAR fair housing publications (1988, 1992, 2010, 2016).
  - Status: confirmed

- **Claim:** "HUD said the data is fine. Your opinion of the data is not."
  - Source: NAR Washington Report 2026-04-29 explicitly cautions: "Subjective commentary, personal opinions, or hearsay about schools or crime have been cited as evidence of discriminatory intent." This is the load-bearing nuance most agents will miss when they read only the headline.
  - Status: confirmed (this is NAR's editorial framing of where the safe harbor ends, not a direct HUD quote)

- **Claim:** Concrete action -- city crime dashboard + state school report card
  - Source: D.J. Paris recommendation. Both are widely available public objective data sources for any U.S. metro. In Chicago specifically, the city's crime dashboard at [data.cityofchicago.org](https://data.cityofchicago.org) and the Illinois State Board of Education's school report card at [illinoisreportcard.com](https://illinoisreportcard.com) are the primary sources. Spoken script keeps the recommendation generic so agents in any market can apply it.
  - Status: D.J.'s editorial recommendation, not a HUD or NAR directive

- **Editorial framing:** "Stopped ducking the question. Without crossing the line."
  - Status: D.J.'s reframe. The data-vs-opinion line is the actual safe harbor; the "without crossing the line" tag makes that vivid.
...
### TikTok
**Caption:**
HUD just told real estate agents you can talk about crime and schools again. There's a catch most agents are about to miss. Here it is.
