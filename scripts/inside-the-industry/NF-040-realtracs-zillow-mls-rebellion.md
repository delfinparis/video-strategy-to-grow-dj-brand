...
- **Claim:** "A second major MLS just threatened to cut Zillow off. Their deadline came and went yesterday."
  - Source: HousingWire, "Realtracs extends Zillow listing feed past June 8 deadline" ([link](https://www.housingwire.com/articles/realtracs-zillow-feed-extended/)); Inman, "Realtracs Keeps Direct Listing Feed To Zillow Alive Amid Negotiations" 2026-06-08 ([link](https://www.inman.com/2026/06/08/realtracs-keeps-direct-listing-feed-to-zillow-alive-amid-negotiations/)); RISMedia 2026-06-08 ([link](https://www.rismedia.com/2026/06/08/realtracs-extends-zillow-deadline-second-extension/)). Realtracs (Nashville) issued a June 8 deadline; the deadline passed without immediate cutoff and negotiations continue.
  - Status: confirmed

- **Claim:** "Realtracs in Nashville. Eighteen thousand brokers across four states."
  - Source: Inman, "A Second Major MLS Says It Will Shut Off Zillow's Listing Feed June 1" 2026-05-27 ([link](https://www.inman.com/2026/05/27/major-mls-says-it-will-shutdown-zillows-listing-feed/)). Realtracs serves roughly 18,000 members across Tennessee, Kentucky, Alabama, and Georgia.
  - Status: confirmed

- **Claim:** "The same 'objective criteria' rule MRED in Chicago was fighting over"
  - Source: Multiple. MRED suspended Zillow's feed in mid-May over "objective criteria" / IDX compliance; Chicago federal court (Judge John Tharp) partially granted Zillow's TRO 2026-05-22 ordering the feed restored. Linked in this branch's NF-027 and NF-038. Realtracs cited the same compliance basis.
  - Status: confirmed

- **Claim:** "Compass CEO Robert Reffkin publicly thanked them"
  - Source: Inman 2026-06-08 coverage notes Reffkin publicly thanked Realtracs after its initial announcement. Compass has been lobbying multiple MLSes to enforce filtering rules consistent with the position Compass has taken in its dispute with Zillow.
  - Status: confirmed

- **Claim:** "Compass spent the last month lobbying MLSes to enforce the rules Zillow is fighting. Two have moved. The rest are watching."
  - Source: Industry reporting across Inman, HousingWire, RISMedia June 2026. Pattern of Compass coordinating with MLSes is documented. "Two have moved" = MRED (Chicago) + Realtracs (Nashville). The "rest are watching" framing is qualitative; the script does not name a specific count.
  - Status: confirmed pattern; "watching" framing is qualitative

- **Series / overlap notes:**
  - Connects to this branch's NF-027 (consumer angle), NF-035 (NY AG Compass antitrust), NF-038 (NAR Policy 8.5 clarifier), NF-039 (Google home search). NF-040 is the spreading-pattern chapter.
  - Distinct from all of them: this is the "the MLS rebellion is replicating" angle. New news (Realtracs deadline 2026-06-08), new actor (Realtracs), new geography (Nashville / TN-KY-AL-GA).
  - Space at least 4-5 days from the other Compass-arc pieces.
